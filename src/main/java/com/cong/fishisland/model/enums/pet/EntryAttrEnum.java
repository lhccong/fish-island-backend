...
public enum EntryAttrEnum {
    ...
    ATTACK("attack", "攻击力", false,
            new double[][]{{1, 3}, {4, 6}, {7, 10}, {11, 15}, {16, 20}}),

    MAX_HP("maxHp", "最大生命值", false,
            new double[][]{{50, 120}, {121, 250}, {251, 420}, {421, 650}, {651, 1000}}),

    DEFENSE("defense", "防御力", false,
            new double[][]{{1, 2}, {3, 5}, {6, 8}, {9, 12}, {13, 16}}),

    /**
     * 速度：决定战斗先手，速度高的一方先攻击；速度相同时随机决定先手
     * 单位：点数（整数）
     */
    SPEED("speed", "速度", false,
            new double[][]{{5, 15}, {16, 30}, {31, 50}, {51, 80}, {81, 120}}),
