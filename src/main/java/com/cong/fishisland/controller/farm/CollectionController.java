...
public class CollectionController {
    ...
    public BaseResponse<List<CollectionDTO>> getMyCollections() {
        ...
        return ResultUtils.success(collectionService.toDTOList(collectionService.getUserCollections(userId)));
    }
    ...
    public BaseResponse<CollectionStatsVO> getCollectionStats() {
        Long userId = StpUtil.getLoginIdAsLong();
        return ResultUtils.success(collectionService.getCollectionStats(userId));
    }
}
