...
public interface PetForgeConstant {
    ...
    /**
     * 鞋子每级闪避率基础系数（单位：%）
     * 实际加成 = SHOES_DODGE_BASE * level^1.5
     * 1级=+0.15%, 10级=+4.74%, 20级=+13.42%（满级约等于1.7条金色闪避词条上限）
     */
    double SHOES_DODGE_BASE = 0.15;
    ...
    /**
     * 项链每级暴击率基础系数（单位：%）
     * 实际加成 = NECKLACE_CRIT_BASE * level^1.5
     * 1级=+0.15%, 10级=+4.74%, 20级=+13.42%（满级约等于1.7条金色暴击词条上限）
     */
    ...
    /**
     * 翅膀每级连击率基础系数（单位：%）
     * 实际加成 = WINGS_COMBO_BASE * level^1.5
     * 1级=+0.15%, 10级=+4.74%, 20级=+13.42%（满级约等于1.7条金色连击词条上限）
     */
