...
(
  ...
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='图鉴收集表';
...
(
  ...
  AUTO_INCREMENT = 26
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='作物表';
...
(
  ...
  AUTO_INCREMENT = 6
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='每日任务表';
...
(
    ...
    `userId`        bigint   NOT NULL COMMENT '用户ID',
    `landIndex`     int      NOT NULL COMMENT '地块序号(1-24)',
  ...
  AUTO_INCREMENT = 37
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='地块表';
...
(
  ...
  AUTO_INCREMENT = 8
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='种植记录表';
...
(
  ...
  AUTO_INCREMENT = 5
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='排行榜表';
...
(
  ...
  AUTO_INCREMENT = 3
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='偷取记录表';
...
(
  ...
  AUTO_INCREMENT = 26
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='任务完成记录表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='农场用户表';

-- 农场好友已改为 user_follow 互相关注，不再使用 farm_friend 表
-- DROP TABLE IF EXISTS `farm_friend`;

-- 蔬菜类作物
INSERT INTO farm_crop (name, category, growthTime, experience, coin, rarity, unlockLevel, price, icon, description,
                       createTime)
VALUES ('胡萝卜', 'vegetable', 30, 7, 3, 1, 1, 1, '', '普通蔬菜', NOW());



# INSERT INTO fish.farm_daily_task (id, name, description, targetCount, rewardExp, `type`, sortOrder, createTime)
